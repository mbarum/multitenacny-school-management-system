...
const Login: React.FC = () => {
  ...
  const handleSsoLogin = (provider: SsoProvider) => {
    ...
    window.location.href = `/api/auth/sso/${slug}/${provider}`;
  };
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <div>
                <button onClick={() => handleSsoLogin(SsoProvider.Google)} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">Google</button>
              </div>
              <div>
                <button onClick={() => handleSsoLogin(SsoProvider.AzureAD)} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">Azure AD</button>
              </div>
              <div>
                <button onClick={() => handleSsoLogin(SsoProvider.Okta)} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">Okta</button>
              </div>
            </div>
          </div>
        </div>
