...
export const SUPER_ADMIN_NAVIGATION_ITEMS: NavItem[] = [
    ...
    // Future: Add 'System Logs', 'Global Settings', etc.
];
...
export const NAVIGATION_ITEMS: NavItem[] = [
    {
        ...
        // Fix: Used Role enum members instead of string literals.
        allowedRoles: [Role.Admin, Role.Accountant, Role.Teacher, Role.Receptionist, Role.Auditor],
    },
    {
        label: 'Students',
        view: 'students',
        ...
        // Fix: Used Role enum members instead of string literals.
        allowedRoles: [Role.Admin, Role.Accountant, Role.Teacher, Role.Receptionist],
    },
    {
    ...
    },
    {
        label: 'Staff & Payroll',
        view: 'staff_payroll',
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h2a2 2 0 012 2v1m-4 0h4m-4 5a2 2 0 100 4 2 2 0 000-4z" /></svg>,
        allowedRoles: [Role.Admin, Role.Accountant],
    },
    {
        label: 'Academics',
    ...
    },
    {
        ...
        view: 'library',
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>,
        allowedRoles: [Role.Admin, Role.Teacher, Role.Receptionist],
    },
    {
        label: 'Attendance',
        view: 'attendance',
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zM7 15l2 2 4-4" /></svg>,
        allowedRoles: [Role.Admin, Role.Teacher],
    },
    {
        label: 'Calendar',
    ...
    },
    {
        ...
        // Fix: Used Role enum members instead of string literals.
        allowedRoles: [Role.Admin, Role.Accountant, Role.Auditor],
    },
    {
        label: 'Settings',
        view: 'settings',
...
export const TEACHER_NAVIGATION_ITEMS: NavItem[] = [
    {
        label: 'Dashboard',
    ...
    {
        label: 'Examinations',
        view: 'teacher_examinations',
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>,
        allowedRoles: [Role.Teacher],
    },
     {
        label: 'Communication',
        view: 'teacher_communication',
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>,
        allowedRoles: [Role.Teacher],
    },
];

export const PARENT_NAVIGATION_ITEMS: NavItem[] = [
    {
        label: 'Dashboard',
