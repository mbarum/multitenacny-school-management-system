...
const FeeManagementView: React.FC = () => {
    ...
    const transactions = Array.isArray(transactionsData?.data) ? transactionsData.data : (Array.isArray(transactionsData) ? transactionsData : []);
    const totalPages = transactionsData?.last_page || Math.max(1, Math.ceil((transactionsData?.total || transactions.length) / 10)) || 1;
