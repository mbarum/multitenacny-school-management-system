                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <Link
                            to="/login"
                            id="nav-portal-login"
                            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold text-slate-700 hover:text-primary-700 bg-slate-100 hover:bg-slate-200/80 border border-slate-200 transition-all hover:scale-[1.02]"
                            title="Access School Management Portal"
                        >
                    ...
                    <div className="lg:hidden bg-white border-b border-slate-200 px-4 pt-3 pb-6 space-y-4 animate-in slide-in-from-top-2 duration-200">
                        ...
                        <div className="pt-3 border-t border-slate-100 flex flex-col gap-2.5">
                            ...
                            <Link
                                ...
                                onClick={() => setMobileMenuOpen(false)}
                                className="w-full py-2.5 px-4 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-800 rounded-xl font-bold text-sm text-center flex items-center justify-center gap-2"
                            >
                                <svg className="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                                </svg>
