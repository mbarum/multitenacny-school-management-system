...
const ParentChildDetails: React.FC = () => {
    ...
    const childAttendance = attendanceRecords.sort((a,b) => new Date(b.date).getTime() - new Date(a.date).getTime());
    
    // Fix: Explicitly cast subjects to Subject[] to avoid 'unknown' type errors
                            ...
                            return (
                                <div key={examId} className="bg-white p-6 rounded-xl shadow-lg">
                                    ...
                                    <table className="w-full text-left table-auto">
                                        ...
                                        <tbody>
                                            {/* Explicitly cast gradesList to Grade[] to fix the unknown type error */}
                    ...
                    <div className="max-h-96 overflow-y-auto">
                        <table className="w-full text-left table-auto">
                            ...
                            <tbody>
                                ...
                                {!loadingAttendance && childAttendance.length === 0 && <tr><td colSpan={2} className="text-center p-4">No attendance records found.</td></tr>}
                            </tbody>
                        </table>
                    </div>
                </div>
