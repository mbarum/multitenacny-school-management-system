                    ...
                    <div className="flex justify-between items-center h-16 -mb-px">
                        ...
                        <div className="hidden sm:block">
                            <h1 className="text-xl sm:text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">
                                Hello, <span className="text-primary-600 dark:text-primary-400">{displayName.split(' ')[0]}</span>
                            </h1>
                        </div>
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-4">
                            ...
                            <button
                                ...
                                type="button"
                                onClick={toggleTheme}
                                className="p-2.5 rounded-xl text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-800 dark:hover:text-white transition-all focus:outline-none focus:ring-2 focus:ring-primary-500/30 flex items-center gap-1.5"
                            ...
                            <div className="relative" ref={notificationsRef}>
                                <button 
                                    ...
                                    className="p-2.5 text-slate-500 dark:text-slate-400 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
                                ...
                                {isMenuOpen && (
                                    <div className="origin-top-right absolute right-0 mt-3 w-64 rounded-2xl shadow-2xl py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 ring-1 ring-black ring-opacity-5 focus:outline-none animate-fade-in-down overflow-hidden">
                                        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50">
                                            <p className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Active Account</p>
